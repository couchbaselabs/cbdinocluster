...
func init() {
	privateEndpointsCmd.AddCommand(privateEndpointsMgmtCmd)

	privateEndpointsMgmtCmd.Flags().Bool("wait-visible", false, "Wait for the DNS to be visible to this host")
}
